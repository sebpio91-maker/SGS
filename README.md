...
ein eigener Thread** erstellt. Das ist die einzige Funktion dieser App, die **nicht** rein lokal im
Browser läuft: Damit mehrere Personen dieselben Threads und Nachrichten sehen, braucht es einen
